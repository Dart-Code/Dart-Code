...
// Note: devtoolsPackageID constant was unused here; references use devtoolsPackageName or server APIs.
	...
	private startServer(hasReinstalled = false): Promise<string> {
		return new Promise<string>(async (resolve, reject) => {
			...
			service.registerForServerStarted((n) => {
				...
				// Example allow-list left here for documentation; actual list comes from config.
				// const _defaultAllowList: string[] = [
				// 	"serverpod.serverpod",
				// ];
				setTimeout(async () => {
					try {
