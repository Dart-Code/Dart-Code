...
class Config {
	...
	get flutterOutline(): boolean { return this.getConfig<boolean>("flutterOutline", false); }
...
class ResourceConfig {
	...
	get flutterStructuredErrors(): boolean { return this.getConfig<boolean>("flutterStructuredErrors", false); }
