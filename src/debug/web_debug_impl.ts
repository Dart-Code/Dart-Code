...
export class WebDebugSession extends FlutterDebugSession {
	...
	protected spawnRunDaemon(isAttach: boolean, args: FlutterLaunchRequestArguments, logger: Logger): RunDaemonBase {
		...
		// TODO: Attach?
		return new WebRun(isAttach ? RunMode.Attach : RunMode.Run, args.pubPath, args.cwd, appArgs, { envOverrides: args.env, toolEnv: this.toolEnv }, args.webDaemonLogFile, logger, this.maxLogLineLength);
	}
}
